...
(() => {
  ...
  var De = (t, e, n) => (
    (n = t != null ? Ce(_e(t)) : {}), Fe(e || !t || !t.__esModule ? ne(n, 'default', { value: t, enumerable: !0 }) : n, t)
  );
  var ae = Me((se, oe) => {
    (function () {
      var t = function (e) {
...
`,
            ...
            if (
              ...
              (v = E[1]),
                ...
                x.test(v) &&
                  ...
                  (O = _),
                  (M = B),
                  x.test(c) ? (c = c + 'e') : O.test(c) ? ((h = w), (c = c.replace(h, ''))) : M.test(c) && (c = c + 'e'));
            }
            if (((h = A), h.test(c))) {
              var E = h.exec(c);
              (v = E[1]), (c = v + 'i');
            ...
            if (s.editsRemaining != 0) {
              ...
              if (s.str.length > 1) {
                var d = s.str.charAt(0),
                  y = s.str.charAt(1),
                  p;
                y in s.node.edges ? (p = s.node.edges[y]) : ((p = new t.TokenSet()), (s.node.edges[y] = p)),
              ...
              for (var S = 0; S < L.length; S++)
                for (var w = L[S], k = this.invertedIndex[w], _ = k._index, f = 0; f < u.fields.length; f++) {
                  var m = u.fields[f],
                    ...
                    $ = new t.Set(A);
                  if (
                    (u.presence == t.Query.presence.REQUIRED && ((y = y.union($)), o[m] === void 0 && (o[m] = t.Set.complete)),
          ...
          for (var e = {}, n = Object.keys(this.fieldTermFrequencies), r = n.length, i = Object.create(null), s = 0; s < r; s++) {
            for (
              ...
              i[f] === void 0 ? ((w = t.idf(this.invertedIndex[f], this.documentCount)), (i[f] = w)) : (w = i[f]),
                (k = (w * ((this._k1 + 1) * m)) / (this._k1 * (1 - this._b + this._b * (l / this.averageFieldLength[a])) + m)),
                (k *= b),
                (k *= g),
  ...
  function ce(t, e) {
    ...
    let n = t.toLocaleLowerCase(),
      ...
      o = n.indexOf(r);
    for (; o != -1; )
      i.push(K(t.substring(s, o)), `<b>${K(t.substring(o, o + r.length))}</b>`), (s = o + r.length), (o = n.indexOf(r, s));
